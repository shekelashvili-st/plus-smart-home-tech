...
public class GlobalExceptionHandler {
    ...
    public Exception handleAlreadyExists(final SpecifiedProductAlreadyInWarehouseException e) {
        String reason = "Product already exists";
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Exception handleLowQuantity(final ProductInShoppingCartLowQuantityInWarehouseException e) {
        String reason = "Product in low quantity at warehouse";
        log.error(reason + ". " + e.getMessage());
        return e;
    }
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Exception handleNoSpecifiedProduct(final NoSpecifiedProductInWarehouseException e) {
        String reason = "No specified product at warehouse";
        log.error(reason + ". " + e.getMessage());
        return e;
    }
